        ...
        <div className={`flex j-c  ${styles.detailsSec}`}>
            ...
            <ul className={`${styles.detailsWhatWeDo}`}>
                <li className={`flex j-s a-c ${styles.itemWhatWeDo}`}>
                    <div className={`bg-ct ${styles.line}`}><div className={`bg-ct ${styles.ballLine}`}></div></div>
                ...
                <li className={`flex j-s a-c ${styles.itemWhatWeDo}`}>
                    <div className={`bg-ct ${styles.line}`}><div className={`bg-ct ${styles.ballLine}`}></div></div>
                    <p className={styles.textFeature}>PR CONSULTATION & ISSUE MARKETIG</p>
                </li>
                <li className={`flex j-s a-c ${styles.itemWhatWeDo}`}>
                    <div className={`bg-ct ${styles.line}`}><div className={`bg-ct ${styles.ballLine}`}></div></div>
                    <p className={styles.textFeature}>GRASSROOTS MARKETING & COMMUNITY ENGAGEMENT</p>
                </li>
                <li className={`flex j-s a-c ${styles.itemWhatWeDo}`}>
                    <div className={`bg-ct ${styles.line}`}><div className={`bg-ct ${styles.ballLine}`}></div></div>
