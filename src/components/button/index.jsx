        ...
        >
          <span className={styles.wrapperText}>
            ...
            <svg
              ...
              <path
                stroke={color}
                d="M 484 18 C 392 -41 192 -38 90 2 C 21 33 4.6 54.6 5.6 77.6 c 1.4 32.4 43.4 60.4 134.4 69.4 c 87 4 160 8 271 -23 C 463 109 507 71 453 34 C 426 16 331 -8 289 -1"></path>
            </svg>
          </span>
        </Link>
      )}
